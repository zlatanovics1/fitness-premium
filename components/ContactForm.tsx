    ...
    <form className="flex gap-20 flex-col h-full">
      ...
      <div className="relative z-0 flex flex-col grow">
        <textarea
          ...
          id="message"
          spellCheck={false}
          className=" block py-3 h-48 resize-none px-2 w-full text-sm text-gray-500 bg-transparent rounded-md border-2 border-gray-600/70 appearance-none focus:outline-none focus:ring-0 focus:border-primary-light peer"
          placeholder=" "
        />
        <label
          htmlFor="message"
