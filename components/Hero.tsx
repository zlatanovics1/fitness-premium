...
import heroImage from "@/public/herofitness (1).jpg";
...
export default function Hero() {
  ...
  return (
    <header className="h-[100vh] max-sm:h-[95vh] flex flex-col justify-center items-center relative overflow-x-hidden">
      ...
      <div className="container px-10 max-sm:-translate-y-40 flex flex-col items-center justify-center">
