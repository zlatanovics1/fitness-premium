...
export default function Browser() {
  return (
    <div className="cursor-pointer relative max-w-[42rem] scale-90 rounded-2xl group  border border-primary-light/50 shadow-sm shadow-primary-dark">
      ...
      <div className="flex items-center justify-center py-2">
        <div className="border pl-3 pr-14  bg-gray-800/80 flex items-center gap-2 border-gray-400 text-gray-400 rounded-md">
          <BiSearch />
